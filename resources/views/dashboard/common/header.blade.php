    ...
    <div class=" dropdown text-slate-200 h-10">
        <div class="h-full dropdown-toggle flex items-center" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            <div class="w-10 h-10 image-fit">
                <img alt="{{!empty(Auth::user())?Auth::user()->name:''}}" class="rounded-full border-2 border-white border-opacity-10 shadow-lg" src="{{!empty(Auth::user()->image)?url(Auth::user()->image):asset('images/404.png')}}">
            </div>
