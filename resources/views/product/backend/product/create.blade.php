...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class=" col-span-12 lg:col-span-4">
            <div class="hidden">
                <input type="text" name="polylang_group_id" value="{{!empty(request()->get('groupID'))?request()->get('groupID'):''}}">
                <input type="text" name="polylang_language" value="{{!empty(request()->get('language'))?request()->get('language'):''}}">
            </div>
