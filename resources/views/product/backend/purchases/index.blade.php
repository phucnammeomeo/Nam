        ...
        <div class="flex justify-between ">
            ...
            <div class="flex flex-col md:flex-row gap-2 md:items-center justify-end">
                <ul class="flex items-center">
                    ...
                    <li>
                        <a href="{{route('suppliers_categories.index')}}" class="flex items-center space-x-1 btn btn-sm btn-primary">
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="font-bold {{config('payment.statusColor')[$v->status]}}">{{config('payment.status')[$v->status]}}</td>
                        <td class="font-bold {{config('payment.financialStatusColor')[$v->financialStatus]}}">{{config('payment.financialStatus')[$v->financialStatus]}}</td>
                        <td class="font-bold {{config('payment.receiveStatusColor')[$v->receiveStatus]}}">{{config('payment.receiveStatus')[$v->receiveStatus]}}</td>
                        <td>
