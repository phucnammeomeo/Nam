            ...
            <div class="w-[580px] max-w-full bg-[#f4f6f8] p-6 rounded-xl">
                ...
                <form action="" method="POST" id="form-auth">
                    ...
                    <div class="mt-5 flex justify-center">
                        <button id="submit-auth" type="submit" class="bg-Pimary_color btn-submit-contact py-4 px-1 md:px-8 rounded-lg block bg-[#3bb77e]  text-white transition-all leading-none text-f15 font-bold" style="width: 50%">{{trans('index.ForgotPasswordSend')}}</button>
                        {{-- <button id="submit-auth-loading" type="button" class="bg-Pimary_color btn-submit-contact py-4 px-1 md:px-8 rounded-lg block bg-[#3bb77e]  text-white transition-all leading-none text-f15 font-bold">Loading...</button> --}}
                    </div>
                </form>
