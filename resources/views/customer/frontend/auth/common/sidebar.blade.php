<div class="aside-information w-full md:w-[250px] lg:w-[376px] order-2 md:order-1 mt-10 md:mt-0 pt-3" style="width: 25%; background-color: antiquewhite">
    <div style="height: 100%">
        <section class="flex items-center mb-1">
            ...
            <div class="flex flex-col ml-3">
                ...
                {{-- <a href="javascript:void(0)" class="font-bold  text-blue-500">
                    Số dư: {{number_format(Auth::guard('customer')->user()->price,'0',',','.')}}₫
                </a> --}}
            </div>
        </section>
        ...
        <div class="flex flex-col gap-3">
            ...
            {{-- <a href="{{route('customer.address')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl ">
