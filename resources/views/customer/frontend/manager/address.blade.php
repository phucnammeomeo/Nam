                    ...
                    <div>
                        <section class="pt-8 flex flex-col items-center">
                            <div class="max-w-screen-mobile">
                                ...
                                <button class="bg-Pimary_color font-bold h-12 w-full text-white bg-global flex-1 cursor-pointer items-center inline-flex rounded-md px-6 justify-center text-[16px] mt-5" onclick="showModalAddress()">
