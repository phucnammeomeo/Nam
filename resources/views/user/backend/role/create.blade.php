...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('roles.store')}}" method="post"
                ...
                <div class="grid grid-cols-12 ">
                    ...
                    <div class="col-span-12 xl:col-span-2">
                        <label for="check{{$val->id}}">
                            <input name="permission_id[]" type="checkbox" class="inputChild" value="{{$val->id}}"
                                id="check{{$val->id}}" />
