        ...
        <div style="display: flex; width:100%" class="title-checkout">
            <div style="width: 50%; margin-top: 10px" class="title-checkout">
                <h1 class="text-lg font-semibold mb-5" style="text-transform: uppercase; font-size: 25px; ">
                    {{ trans('index.BillingInformation') }}</h1>
            </div>
            <div style="width: 50%; margin-top: 10px; display: flex; " class="group-btn">
                ...
                <a href="{{ route('cart.index') }}" style="width: 50%; text-align: right; font-weight: 700">Giỏ hàng của bạn</a>
            </div>
        </div>
                    ...
                    <div class="col-span-12 lg:col-span-5 mt-4 mt-lg-0"
                        ...
                        <div>
                                    ...
                                    <div class="bg-slate-100 p-2 md:p-10">
                                        <div class="your-order-product-info">
                                            ...
                                            <ul class="flex flex-wrap items-center justify-between border-b  py-5 my-5">
                                                <li class="text-base font-semibold">{{trans('index.Provisional')}} <span  style="font-style: italic; color: orange;">(<?php echo $cart['quantity'] ?> sản phẩm)</span></li>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="space-y-4">
                                    @if(!empty(Auth::guard('customer')->user()->price))
                                    <div>
