                            ...
                            <?php $__currentLoopData = $partners->slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mr-[5px]">
                                    <a target="_blank" href="<?php echo e(url($slide->link)); ?>"><img
                                            src="<?php echo e(asset($slide->src)); ?>" alt="Thành viên cùng chủ quản"/></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    <?php endif; ?>
                ...
                <?php if($OurFeatures && count($OurFeatures->slides) > 0): ?>
                    <ul class="flex flex-wrap mt-[10px] logo-footer">
                        <?php $__currentLoopData = $OurFeatures->slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mr-[5px]">
                                <a target="_blank" href="<?php echo e(url($slide->link)); ?>"><img
                                        src="<?php echo e(asset($slide->src)); ?>" alt="Chứng nhận kinh doanh" /></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                <?php endif; ?>
...
<?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/homepage/common/menuFooter.blade.php ENDPATH**/ ?>