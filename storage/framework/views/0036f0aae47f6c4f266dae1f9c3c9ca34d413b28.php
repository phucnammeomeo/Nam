...
$loop = !empty($content['title']) ? $content['title'] : (!empty($content['image']) ? $content['image'] : (!empty($content['description']) ? $content['description'] : []));
...
<div class="mt-3 box p-5">
    ...
    <div id="schedule-<?php echo $keyword_convert ?>">
        <?php if(isset($loop) && is_array($loop) && count($loop)): ?>
        <?php $__currentLoopData = $loop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/components/field/json.blade.php ENDPATH**/ ?>