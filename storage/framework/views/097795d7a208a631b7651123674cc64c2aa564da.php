...
<script>
    ...
    function get_list_object(page = 1) {
        ...
        let keyword = $('input[name="keywordFilter"]').val();
...
<script>
    ...
    $(document).on('click', '.js-handle-filter-mobile', function(e) {
        $('#tp-col-filter').removeClass('hidden sticky pr-1').addClass('bg-white fixed w-full p-4');
    })
...
<?php $__env->stopPush(); ?><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/product/frontend/category/script.blade.php ENDPATH**/ ?>