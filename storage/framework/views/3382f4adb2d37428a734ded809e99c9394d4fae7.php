...
<div class="content">
    ...
    <form action="" class="grid grid-cols-12 gap-2 mt-5" id="search" style="margin-bottom: 0px;">
        ...
        <div class="col-span-4">
            <?php echo Form::text('date', request()->get('date'), ['class' => 'form-control h-10',  'autocomplete' => 'off']); ?>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/order/backend/index.blade.php ENDPATH**/ ?>