        ...
        <div class="grid grid-cols-12 -mx-4 header-table">
            <div class="col-span-12 lg:col-span-3 px-4 order-last mt-8 lg:mt-0 header-table-cart">
                <div class="mt-4 lg:mt-0 header-table-cart-price flex" style="margin: 10px 0; border:solid 1px silver">
                    <div class="bg-slate-100 p-2 header-cart-price" style="width: 70%; margin-top: 10px;">
                    ...
                    <div class="mt-3 " style="width: 30%; margin: auto; height: 100%;">
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/agri-raw.com/public_html/resources/views/cart/index.blade.php ENDPATH**/ ?>