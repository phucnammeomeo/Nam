                ...
                <div class="tab-content">
                    <div id="example-tab-homepage" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="example-homepage-tab">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-2">
                                <?php echo Form::textarea('title_category_description', '', ['id' => 'cke_Description', 'class' => 'ck-editor-description', 'style' => 'height:60px;font-size:14px;line-height:18px;border:1px solid #ddd;padding:10px']); ?>
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-2">
                                <?php echo Form::textarea('category_description', '', ['id' => 'cke_Content', 'class' => 'ck-editor', 'style' => 'height:60px;font-size:14px;line-height:18px;border:1px solid #ddd;padding:10px']); ?>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/agri-raw.com/public_html/resources/views/product/backend/category/create.blade.php ENDPATH**/ ?>