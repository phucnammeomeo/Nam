...
<script>
    ...
    function render_schedule() {
        ...
        html = html + '</div>'
        html = html + '<select name="data[type][]" class="form-control w-full col-span-3  mt-3 md:mt-0"><option value="image">image</option><option value="files">files</option><option value="input">input</option><option value="textarea">textarea</option><option value="editor">editor</option></select>'
        html = html + '</div>'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/config/colums/create.blade.php ENDPATH**/ ?>