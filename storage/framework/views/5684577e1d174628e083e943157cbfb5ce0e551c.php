      ...
      <div style="text-align: right;;border:0px" class="flex-1">
          <div class="flex text-danger font-bold justify-end items-center space-x-1 relative">
              <a href="javascript:void(0)" class="js_toggleDiscount flex items-center space-x-1">
                  ...
                  <input type="text" class="form-control hidden" name="discount[value]">
                  <input type="text" class="form-control hidden" name="discount[type]">
                  <input type="text" class="form-control hidden" name="discount[price]">
  ...
  <?php $__env->stopPush(); ?>
  <!-- END: script chiết khấu --><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/product/backend/purchases/discount.blade.php ENDPATH**/ ?>