        ...
        <div class="col-span-12 md:col-span-7 mt-5 md:mt-0">
            ...
            <div class="">
                ...
                <div class="flex flex-wrap md:flex-nowrap">
                    ...
                    <?php if($kimage <= 4): ?> <div class=" object-cover mr-4 cursor-pointer border border-slate-100 mb-2 review_images_item">
                ...
                <?php endif; ?>
                <?php if($kimage == 5): ?>
                <div style="width: 60px;" class="flex-auto h-[60px] object-cover cursor-pointer bg-cover relative rounded review_images_item">
                    <a href="<?php echo $image ?>" data-fancybox="images" rel="group1">
                        <img src="<?php echo $image ?>" alt="ảnh cmt" class="object-cover h-[60px]">
                        <?php if(count($list_images_cmt) > 6): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/product/frontend/product/comment/index.blade.php ENDPATH**/ ?>