...
<div class="content">
    ...
    <form id="formPurchases" class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('product_purchases.store')); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
        <div class="col-span-12 lg:col-span-8 space-y-3">
                ...
                <div class="p-5 grid ">
                    <div class="relative">
                        ...
                        <div class="absolute top-10 left-0 w-full border shadow bg-white z-10" id="loadDataSuppliers" style="display: none;">
                            <?php echo $__env->make('product.backend.purchases.create.suppliers', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
            ...
            <div class="box">
                ...
                <div class="p-5 grid ">
                    <div class="relative">
                        ...
                        <div class="absolute top-10 left-0 w-full border shadow bg-white z-10" id="loadDataProducts" style="display: none;">
                            <?php echo $__env->make('product.backend.purchases.create.products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
                <div class="">
                ...
                <div>
                    ...
                    <?php echo $__env->make('product.backend.purchases.create.discount', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <div class="js_html_VAT">

                    </div>
                    <?php echo $__env->make('product.backend.purchases.create.surcharge', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <div class="flex justify-between p-4">
...
<?php echo $__env->make('product.backend.purchases.create.modalProduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/product/backend/purchases/create.blade.php ENDPATH**/ ?>