...
<div class="content">
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <form class="col-span-12 lg:col-span-8" method="post" action="<?php echo e(route('customer_socials.update',['id'=>$detail->id])); ?>">
            <?php echo csrf_field(); ?>
            <div class="">
                <div class=" box">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/agri-raw.com/public_html/resources/views/customer/backend/social/index.blade.php ENDPATH**/ ?>