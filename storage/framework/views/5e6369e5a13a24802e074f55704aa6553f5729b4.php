<section class="pb-md-0 background_bg overlay_bg_dark_80" data-img-src="<?php echo e(asset($fcSystem['banner_3'])); ?>" id="formCart">
    <div class="container">
        <div class="row">
                ...
                <div class="book_table overlay_bg_50 radius_all_10 ">
                    ...
                    <form method="post" class="form_transparent form_style1" autocomplete="off">
                        ...
                        <div class="row text_white">
                            ...
                            <div class="form-group col-sm-6">
                                <div class="custom_select">
                                    <select class="form-control" name="person">
                                        ...
                                        <?php for( $i=1; $i<=20 ; $i++): ?> <option value="<?php echo e($i); ?>"><?php echo e($i); ?> người</option>
                                            <?php endfor; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                <div class="input_group">
                                    <input placeholder="Giờ" class="form-control timepicker" data-theme="red" name="hour" type="text" value="<?php echo e(date('H:s:i')); ?>">
                                    <div class="input_icon">
                    ...
                    <div class="opening_time text_white">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="time_info">
                                    <h6><?php echo e($fcSystem['title_3']); ?></h6>
                                    <span><?php echo e($fcSystem['title_4']); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="time_info">
                                    <h6><?php echo e($fcSystem['title_5']); ?></h6>
                                    <span><?php echo e($fcSystem['title_6']); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 col-lg-5">
                <div class="text-center chef_img animation" data-animation="fadeInRight" data-animation-delay="0.03s">
                    <img src="<?php echo e(asset($fcSystem['banner_4'])); ?>" alt="chef_img" />
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\food.local\resources\views/homepage/common/formCart.blade.php ENDPATH**/ ?>