            ...
            <div class="mt-5">
                ...
                <div class="phone-phone">
                    <div class="flex flex-wrap justify-between mx-[-5px]">
                        ...
                        <div class="w-full md:w-1/2 px-[5px]">
                            <a href="tel:<?php echo e($fcSystem['contact_hotline2']); ?>" class="w-full inline-block py-[7px] text-white bg-Pimary_color text-center text-f16 font-bold rounded-[25px] border border-red hover:bg-white hover:text-red transition-all">
                                <i class="fa-solid fa-phone mr-2"></i>
...
<?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/product/frontend/product/data.blade.php ENDPATH**/ ?>