<?php $__env->startSection('content'); ?>
    ...
    ?>
    <div class="py-9 bg-white px-4" style="margin-top: 10px">
        <div style="display: flex; width:100%">
            ...
            <div style="width: 50%; margin-top: 10px; display: flex; ">
        ...
        <form id="myForm" class="checkout" action="<?php echo e(route('cart.order')); ?>" method="POST">
            <div class="container mx-auto">
                <div class="grid grid-cols-12 gap-5" style="display: flex; width: 100%">
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/cart/checkout.blade.php ENDPATH**/ ?>