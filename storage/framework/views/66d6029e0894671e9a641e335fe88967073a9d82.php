    ...
    <div class="container px-4 mx-auto">
        <div class="mt-4 flex flex-col md:flex-row items-start md:space-x-4">
            ...
            <div class="flex-1 w-full md:w-auto order-1 md:order-1">
                <form action="<?php echo e(route('cart.order')); ?>" id="myForm" method="post">
                    <input type="hidden" name="copyCartID" value="<?php echo e($detail->id); ?>">
                    <div class="shadowC rounded-xl p-6 space-y-10 md:space-y-4">
                        ...
                        <div class="">
                            <h2 class="font-bold text-lg"><?php echo e(trans('index.OrderDetails')); ?></h2>
                            <div class="listCart mt-5 space-y-3" id="listCart">
                                <?php $total = $price_coupon = 0; ?>
                                <?php if($cartCopy): ?>
                                <?php $__currentLoopData = $cartCopy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                        ...
                        <div class="relative w-full">
                            ...
                            <input placeholder="<?php echo e(trans('index.MoreNewProducts')); ?>" type="text" value="" class="js_search_product rounded-lg border w-full h-11 px-3 focus:outline-none focus:ring focus:ring-red-300 focus:rounded-lg hover:outline-none hover:ring hover:ring-red-300 hover:rounded-lg pl-14" name="keyword" autocomplete="off">
                            <div class="js_list_product absolute w-full left-0 top-[44px] bg-white shadowC z-50 p-4" style="display: none">
                                <div class="flex justify-between items-center">
                                    <div class="flex space-x-3 items-center mb-2">
                                        ...
                                        <h2 class="font-medium"><?php echo e(trans('index.SelectProduct')); ?></h2>
                                    </div>
                                    <div>
                                ...
                                <div class="mt-2 border-t" id="loadDataProduct">
                                    <?php echo $__env->make('customer.frontend.order.dataProduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="flex">
                                ...
                                ?>
                                <?php endif; ?>
                                <input name="title_ship" type="text" class="hidden" value="<?php echo e($title_ship); ?>">
                                <input name="fee_ship" type="text" class="hidden" value="<?php echo e($fee_ship); ?>">
                                <div class="w-1/2 md:w-3/4 text-right">
                                    <?php echo e(trans('index.TransportFee')); ?>

                                </div>
                                <div class="flex-1 text-right font-bold js_fee_shipping">
                                    <?php echo e(number_format($fee_ship,'0',',','.')); ?>₫
                                </div>
                            </div>
                            <div class="flex text-base md:text-xl">
                                <div class="w-1/2 md:w-3/4 text-right font-black">
                                    <?php echo e(trans('index.TotalPrice')); ?>

                                </div>
                                <div class="flex-1 text-right font-black text-global cart-total-copy">
                                    <?php echo e(number_format($total+$fee_ship,0,',','.')); ?>₫
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="">
                            <div>
                                <h3 class="font-bold text-lg mb-5"><?php echo e(trans('index.BillingInformation')); ?></h3>
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5">
                                    ...
                                    <div class="lg:col-span-2 mb-5 grid md:grid-cols-3 md:gap-4">
                                        <div>
                                            <label class="mb-3 inline-block font-bold"><?php echo e(trans('index.City')); ?></label>
                                            <?php
                                        ...
                                        <div>
                                            <label class="mb-3 inline-block font-bold"><?php echo e(trans('index.District')); ?></label>
                                            <?php
                                        ...
                                        <div>
                                            <label class="mb-3 inline-block font-bold"><?php echo e(trans('index.Ward')); ?></label>
                                            <?php
                                ...
                                <div class="mt-5 flex justify-end">
                                    <button type="submit" class="js_btn_submit_copy_cart text-center leading-none uppercase bg-red-600 text-white text-sm bg-dark px-10 py-5 transition-all hover:bg-orange font-semibold"><?php echo e(trans('index.Order')); ?></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/agri-raw.com/public_html/resources/views/customer/frontend/order/copy.blade.php ENDPATH**/ ?>