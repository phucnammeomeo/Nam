        ...
        <div class="input-box">
            <form method="post" action="<?php echo e(route('update-menu-item',$item['id'])); ?>" enctype="multipart/form-data">
                ...
                <div class="input-group mt-3">
                    ...
                    <input type="text" name="slug" class="form-control" placeholder="" value="<?php echo e($item['slug']); ?>" readonly>
                </div>
...
<?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/menu/backend/renderMenuItem.blade.php ENDPATH**/ ?>