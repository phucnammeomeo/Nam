...
<nav class="side-nav">
    ...
    <div class="scrollable">
        <ul class="scrollable__content">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('keywords_index')): ?>
                <?php if (in_array('keywords', $dropdown)) { ?>
                <li>
                    <a href="<?php echo e(route('keywords.index')); ?>" class="side-menu <?php echo e(activeMenu('keywords')); ?>">
                ...
                <li>
                    ...
                    <ul class="<?php if ($module === 'category_products' || $module === 'products' || $module === 'brands' || $module === 'product_purchases' || $module === 'suppliers' || $module === 'suppliers_categories') { ?>side-menu__sub-open<?php } ?>">
                        ...
                        <?php if (in_array('product_purchases', $dropdown)) { ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('product_purchases.index')); ?>" class="side-menu <?php echo e(activeMenu('product-purchases')); ?>">
                                    <div class="side-menu__icon"> <i data-lucide="aperture"></i> </div>
                        ...
                        <?php if (in_array('suppliers', $dropdown)) { ?>
                            <li>
                                <a href="<?php echo e(route('suppliers.index')); ?>" class="side-menu  <?php echo e(activeMenu('suppliers')); ?> <?php echo e(activeMenu('suppliers-categories')); ?>">
                                    <div class="side-menu__icon"> <i data-lucide="aperture"></i> </div>
                ...
                <li>
                    ...
                    <ul class="<?php if ($module === 'payment_groups' || $module === 'payment_vouchers' || $module === 'receipt_groups' || $module === 'receipt_vouchers') { ?>side-menu__sub-open<?php } ?>">
                        <?php if (in_array('receipt_vouchers', $dropdown) && !empty($module)) { ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('receipt_vouchers_index')): ?>
                            <li>
                                <a href="<?php echo e(route('receipt_vouchers.index')); ?>" class="side-menu <?php echo e(activeMenu('receipt-vouchers')); ?>">
                                    <div class="side-menu__icon"> <i data-lucide="aperture"></i> </div>
                        ...
                        <?php if (in_array('payment_vouchers', $dropdown) && !empty($module)) { ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('payment_vouchers.index')); ?>" class="side-menu <?php echo e(activeMenu('payment-vouchers')); ?>">
                                    <div class="side-menu__icon"> <i data-lucide="aperture"></i> </div>
            ...
            <?php if (in_array('contacts', $dropdown) && !empty($module)) { ?>
                <li>
                    ...
                    <ul class="<?php if ($module === 'contacts') { ?>side-menu__sub-open<?php } ?>">
                        ...
                        <li class="hidden">
                            <a href="<?php echo e(route('machining.index')); ?>" class="side-menu <?php echo e(activeMenu('machining')); ?>">
                                <div class="side-menu__icon"> <i data-lucide="aperture"></i> </div>
...
</nav><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/dashboard/common/sidebar.blade.php ENDPATH**/ ?>