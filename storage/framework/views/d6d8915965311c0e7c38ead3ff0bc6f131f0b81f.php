    ...
    <div class="relative p-4 h-full md:h-auto w-[790px]">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form id="form-addReturn" class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="">
                <h3 class="text-black font-bold text-xl"><?php echo e(trans('index.ToReturn')); ?></h3>
                <?php echo csrf_field(); ?>
                ...
                <div class="flex justify-end space-x-2">
                    <button type="button" onclick="handleCloseReturn()" class="text-black hover:text-white bg-gray-300 hover:bg-rose-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-global dark:hover:bg-rose-600 dark:focus:ring-blue-800"><?php echo e(trans('index.Cancel')); ?></button>
                    <button type="submit" class="js_submit_return_order text-white bg-global hover:bg-rose-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-global dark:hover:bg-rose-600 dark:focus:ring-blue-800">
                        <?php echo e(trans('index.ToReturn')); ?>
...
<?php $__env->stopPush(); ?>
<!-- END: hoàn trả --><?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/customer/frontend/order/return.blade.php ENDPATH**/ ?>