...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('payment_vouchers.update', ['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box mt-3">
                ...
                <div class="p-5 grid grid-cols-2 gap-2">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <?php echo Form::select('type', config('payment.method'), $detail->type, ['class' => 'form-control w-full', 'disabled']); ?>
                    </div>
                    <div class="col-span-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/cashbook/payment/payment/edit.blade.php ENDPATH**/ ?>