...
<div class="banner-wrapper no_background">
    <div class="banner-wrapper-inner">
        <nav class="furgan-breadcrumb">
            <a href="<?php echo url('') ?>"><?php echo e(trans('index.home')); ?></a>
            <i class="fa fa-angle-right"></i>
            <a href="javascript:void(0)"><?php echo e($page->title); ?></a>
        </nav>
    </div>
</div>
            ...
            <div class="grid grid-cols-12 gap-5">
                ...
                <div class="col-span-12 lg:col-span-5 mt-4 mt-lg-0">
                    <div>
                            ...
                            <div class="your-order-product-info">
                                ...
                                <ul class="border-t border-b py-5 my-5">
                                    ...
                                    <li class="flex flex-wrap items-center justify-between">
                                        <span class="w-1/2"><?php echo e($v['title']); ?> <?php echo $title_version ?> X <b class="text-orange"><?php echo e($v['quantity']); ?> <?php echo e($unit); ?></b></span>
                        ...
                        <div class="mt-6">
                            <button type="submit" class="js_btn_submit flex justify-center items-center w-full text-center leading-none uppercase bg-ColorPrimary text-white text-sm bg-dark transition-all hover:bg-orange font-semibold"><?php echo e(trans('index.Order')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\food.local\resources\views/cart/checkout.blade.php ENDPATH**/ ?>