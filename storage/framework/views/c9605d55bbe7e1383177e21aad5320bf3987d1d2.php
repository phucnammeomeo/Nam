...
<div class="banner-wrapper has_background">
    <img style="width: 100%;" src="<?php echo e(asset($fcSystem['banner_3'])); ?>" alt="Tag: <?php echo e($detail->title); ?>" class="img-responsive attachment-1920x447 size-1920x447">
    <div class="banner-wrapper-inner">
        <h1 class="page-title">Tag: <?php echo e($detail->title); ?></h1>
        <div role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
            <ul class="trail-items breadcrumb">
                <li class="trail-item trail-begin"><a href="<?php echo url('') ?>">Trang chủ</a></li>
                <li><a href="javascript:void(0)" class="trail-item trail-end active">Tag: <?php echo e($detail->title); ?></a></li>
            </ul>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/tag/frontend/product.blade.php ENDPATH**/ ?>