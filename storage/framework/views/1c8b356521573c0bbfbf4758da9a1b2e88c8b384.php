    ...
    <div class="modal-wrapper modal-transition">
        ...
        <div class="modal-body">
            <div class="modal-content">
                ...
                <div class="desc-2 text-center ship-information"><?php echo (isset($shipLocation) && is_array($shipLocation) && count($shipLocation))?$shipLocation['description']:''; ?></div>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/homepage/common/shippingLocation.blade.php ENDPATH**/ ?>