 ...
 <div class="row flex flex-wrap justify-between -mx-3">
     <div class="w-full md:w-3/5 px-3">
         ...
         <div class="endow-2 border border-gray-100 rounded-[10px] p-[15px] mt-[20px] ">
             <p class="mb-5px">
                 <img src="img/icon-1.png" alt="" class="inline-block">

                 <?php echo e($fcSystem['title_9']); ?> <strong><?php echo e($fcSystem['title_10']); ?></strong>

                 <?php echo e($fcSystem['title_11']); ?>

             </p>
             <p class="">
                 <img src="img/iocn-2.png" alt="" class="inline-block">

                 <?php echo e($fcSystem['title_12']); ?> <strong><?php echo e($fcSystem['title_13']); ?></strong>
         ...
         <div class="w-full py-4">
             ...
             <div class="mt-5">
                 ...
                 <div class="endow border border-Pimary_color rounded-[10px] p-[15px] mt-[20px]">
                     ...
                     <p class="mb-[5px]">Ngày lễ giảm đến 25% </p>                     
...
<?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/product/frontend/product/data.blade.php ENDPATH**/ ?>