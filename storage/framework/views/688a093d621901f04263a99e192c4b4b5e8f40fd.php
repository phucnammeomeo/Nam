        ...
        <div class="input-box">
            <form method="post" action="<?php echo e(route('update-menu-item',$item['id'])); ?>" enctype="multipart/form-data">
                ...
                <div class="input-group mt-3">
                    ...
                    <input type="text" name="slug" class="form-control" placeholder="" value="<?php echo e($item['slug']); ?>">
                </div>
...
<?php /**PATH C:\xampp\htdocs\khangdien\resources\views/menu/backend/renderMenuItem.blade.php ENDPATH**/ ?>