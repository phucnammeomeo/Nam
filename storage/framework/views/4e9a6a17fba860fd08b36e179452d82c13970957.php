    ...
    <div class="contact-btottom  bg-white p-[10px] mt-[20px]">
        ...
        <div class="flex flex-wrap justify-between -mx-3">
            <div class="w-full md:w-1/2 px-3 mt-4 md:mt-0">
              ...
              ><?php echo e($fcSystem['contact_tglv']); ?>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/contact/frontend/index.blade.php ENDPATH**/ ?>