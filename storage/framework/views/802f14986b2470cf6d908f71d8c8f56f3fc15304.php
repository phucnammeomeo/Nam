...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('category_products.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div id="example-tab-homepage" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="example-homepage-tab">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('slug', $detail->slug, ['class' => 'form-control canonical', 'data-flag' => 0, 'required','readonly']); ?>
                            </div>
                        </div>
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Mô tả SEO</label>
                            <div class="mt-2">
                                <?php echo Form::textarea('description', $detail->description, ['id' => 'ckContent', 'class' => 'ck-editor', 'style' => 'height:60px;font-size:14px;line-height:18px;border:1px solid #ddd;padding:10px']); ?>
                            </div>
                        </div>
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Tiêu đề mô tả danh mục</label>
                            <div class="mt-2">
                                <?php echo Form::textarea('title_category_description', $detail->title_category_description, ['id' => 'ckDescription', 'class' => 'ck-editor-description', 'style' => 'height:60px;font-size:14px;line-height:18px;border:1px solid #ddd;padding:10px']); ?>
                            </div>
                        </div>

                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Mô tả danh mục sản phẩm</label>
                            <div class="mt-2">
                                <?php echo Form::textarea('category_description', $detail->category_description, ['id' => 'cke_Content', 'class' => 'ck-editor', 'style' => 'height:60px;font-size:14px;line-height:18px;border:1px solid #ddd;padding:10px']); ?>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/product/backend/category/edit.blade.php ENDPATH**/ ?>