    ...
    <div class="relative flex justify-center">
        ...
        <div href="javascript:void(0)" class="absolute top-1/2 right-0 -translate-y-1/2">
            <a href="javascript:void(0)" class="text-f25 text-center relative tp-cart">
                ...
                <span class="absolute w-5 h-5 leading-5 rounded-full bg-[#d61c1f] text-[10px] text-white -right-[6px] top-0 text-center cart-quantity"><?php echo e($cart['quantity']); ?></span>
            </a>
        </div>
    </div>
...
</header><?php /**PATH C:\xampp\htdocs\khangdien\resources\views/templates/header/header-mobile.blade.php ENDPATH**/ ?>