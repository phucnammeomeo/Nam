                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            <div class="form-switch">
                                                ...
                                                <input type="text" name="_stock_status[]" value="<?php echo e($_stock_status[$key]); ?>" class="hidden">
                                                <div class="form-check">
                                                    <input id="horizontal-form-<?php echo e($key); ?>" class="form-check-input selectStock" type="checkbox" value="1" <?php if($_stock_status[$key]==1): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="showStock <?php if($_stock_status[$key]==0): ?> hidden <?php endif; ?>">
                                            ...
                                            <div class="mt-3">
                                                <input type="text" name="_outstock_status[]" value="<?php echo e($_outstock_status[$key]); ?>" class="hidden">
                                                <div class="form-check">
...
</div><?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/product/backend/product/common/attribute.blade.php ENDPATH**/ ?>