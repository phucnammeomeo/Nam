            ...
            <div class="box p-2">
                <div class="overflow-x-auto" id="toTop">
                    ...
                    <table class="table mt-5">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="!pt-6 border-transparent dark:!border-transparent text-right font-medium w-32 js_provisional"><?php echo e(number_format($total,0,',','.')); ?>₫</td>
                            </tr>
                            <?php
                            $fee_ship = 0;
                            $title_ship = '';
                            ...
                            <tr>
                                ...
                                <td class="border-transparent dark:!border-transparent text-right font-medium w-32 js_fee_shipping"><?php echo e(number_format($fee_ship,0,',','.')); ?>₫</td>
                            </tr>
                            <?php endif; ?>

                            <tr>
                                <td colspan="4" class="border-transparent dark:!border-transparent font-medium text-right w-32">Tổng tiền</td>
                                <td class="border-transparent dark:!border-transparent text-right w-32 text-danger text-xl font-bold cart-total-final"><?php echo e(number_format($total+$fee_ship,0,',','.')); ?>₫</td>
                            </tr>
                        </tfoot>
                    </table>
                    ...
                    <div class="flex justify-between items-center space-x-2">
                        ...
                        <div>
                            <a href="<?php echo e(route('customers.orders',['id' => $detail->id,'remove' => $detailOrder->id])); ?>" class="btn btn-danger">Hủy</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/customer/backend/order/create.blade.php ENDPATH**/ ?>