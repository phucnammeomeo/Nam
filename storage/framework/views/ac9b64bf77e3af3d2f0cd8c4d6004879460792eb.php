        ...
        <div class="modal-content">
            ...
            <div class="modal-body space-y-3">
                ...
                <div id="loadDataModalProducts">
                    <?php echo $__env->make('product.backend.purchases.create.ajaxProductModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <!-- END: Modal Body -->
            <!-- BEGIN: Modal Footer -->
