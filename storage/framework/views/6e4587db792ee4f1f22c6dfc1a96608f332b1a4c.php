...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('media.update',['id' => $detail->id])); ?>"
                ...
                <div class="mt-3">
                    <div class="grid md:grid-cols-2">
                        ...
                        <div class="ml-3">
                            ...
                            <select name="catalogue[]" class="form-control tom-select tom-select-custom w-full"
                                multiple>
                                <option value=""></option>
                ...
                <div class="mt-3 ">
                    <div class="wrap-direct mb-3">
                        <span class="video-direct flex mb-3 mr-3">
                            <input class="choose_video_type"
                                <?php echo (old('video_type') == 0) ? 'checked' : (($detail->video_type == 0) ? 'checked' : ''); ?>
                    ...
                    <div class="wrap-iframe">
                        <span class="video-iframe flex  mb-3 mr-3">
                            <input
                                <?php echo (old('video_type') == 1) ? 'checked' : (($detail->video_type == 1) ? 'checked' : ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\food.local\resources\views/media/backend/media/edit.blade.php ENDPATH**/ ?>