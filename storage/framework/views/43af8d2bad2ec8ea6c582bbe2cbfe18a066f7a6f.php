...
<div class="banner-wrapper has_background">
    <img style="width: 100%;" src=" <?php echo e(!empty($page->image) ? (!empty(File::exists(base_path($page->image)))?asset($page->image):asset($fcSystem['banner_3'])) : asset($fcSystem['banner_3'])); ?>" alt="<?php echo e($page->title); ?>" class="img-responsive attachment-1920x447 size-1920x447">
    <div class="banner-wrapper-inner">
        ...
        <div role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
            <ul class="trail-items breadcrumb">
                ...
                <li><a href="javascript:void(0)" class="trail-item trail-end active"><?php echo e($page->title); ?></a></li>
            </ul>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/page/frontend/products.blade.php ENDPATH**/ ?>