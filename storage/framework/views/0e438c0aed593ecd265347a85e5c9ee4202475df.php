...
<header class="block md:hidden header-mobile">
    <div class="relative flex justify-center px-2 py-[10px] header-22">
        ...
        <div class="w-full text-center">
            ...
            <a href="/" class="logo"><img src="<?php echo e(asset($fcSystem['homepage_logo'])); ?>" alt=""
                    class="inline-block" /></a>
            
                <a id="primary-nav-button1" href="<?php echo e(route('cart.index')); ?>"
            ...
            <form action="<?php echo e(route('homepage.search')); ?>" method="get" class="mt-1">
                ...
                <ul class="dropdown menu">
                    <li>
                        <?php if(Auth::guard('customer')->user()): ?>
                            <a href="<?php echo e(route('customer.orders')); ?>">Tài khoản của bạn</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('customer.login')); ?>">Đăng nhập</a>
                        <?php endif; ?> 
                    </li>
                                ...
                                <ul class="sub-menu">
                                    <?php $__currentLoopData = $item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <li style="margin-left: 30px">
                                            <a href="<?php echo e(url($item2->slug)); ?>" <?php echo $_blank_2; ?>><?php echo e($item2->title); ?>
...
<?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/homepage/common/menuMobile.blade.php ENDPATH**/ ?>