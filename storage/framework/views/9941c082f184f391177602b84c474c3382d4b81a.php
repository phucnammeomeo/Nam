<?php $__env->startSection('content'); ?>
    ...
    <div class="content-product mt-[30px] bg-white">
        ...
        <div class="pagenavi wow fadeInUp mt-[20px] pb-[20px]">
         ...
         <?php if(!empty($detail->category_description)): ?>
            <div class="box-content border border-Pimary_color p-[15px] rounded-[10px] mt-[20px]">

                <div class="status-meeting" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                    <?php echo $detail->title_category_description; ?>
                </div>
                <div class="read-more-content">
                    <div class="status-meeting">
                        <?php echo $detail->category_description; ?>
                    </div>
                </div>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/agri-raw.com/public_html/resources/views/product/frontend/category/index.blade.php ENDPATH**/ ?>