        ...
        <div class="flex flex-wrap justify-between mx-[-10px] items-center">
            <div class="w-full md:w-1/2 px-[10px] mb-[10px] md:mb-0">
                <p class="flex flex-wrap">
                    <span class=""><img src="<?php echo e(asset($fcSystem['homepage_logo_footer_1'])); ?>" alt="" />
                    </span>
            ...
            <div class="w-full md:w-1/2 px-[10px]">
                <p class="flex flex-wrap">
                    <span class=""><img src="<?php echo e(asset($fcSystem['homepage_logo_footer_2'])); ?>" alt="" />
                    </span>
                ...
                <div class="flex flex-wrap justify-between mx-[-5px] mt-[10px]">
                    <?php if($partners && count($partners->slides) > 0): ?>
                        <ul class="flex flex-wrap mt-[10px]">
                            <?php $__currentLoopData = $partners->slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mr-[5px]">
                                    <a target="_blank" href="<?php echo e(url($slide->link)); ?>"><img
                                            src="<?php echo e(asset($slide->src)); ?>" /></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    <?php endif; ?>
...
<?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/homepage/common/menuFooter.blade.php ENDPATH**/ ?>