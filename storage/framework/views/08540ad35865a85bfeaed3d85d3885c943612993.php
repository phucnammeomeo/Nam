<?php $__env->startSection('content'); ?>
    ...
    ?>
    <div class="py-9 bg-white px-10 main-checkout">
        <div class="container mx-auto px-3">
            <div style="display: flex; width:100%" class="title-checkout">
                <div style="width: 50%;" class="title-checkout mt-[40px]">
                    <h1 class="text-lg font-semibold mb-5" style="text-transform: uppercase; font-size: 25px; ">
                        <?php echo e(trans('index.BillingInformation')); ?></h1>
                </div>
                <div style="width: 50%; display: flex; " class="group-btn mt-[40px]">
                    <a href="/san-pham" style="width: 50%; color: orange; font-weight: 500; margin-left: 10px"><i class="fa-solid fa-chevron-left" style="margin-right: 5px; font-size: 13px"></i> Mua thêm sản phẩm khác</a>
                    <a href="<?php echo e(route('cart.index')); ?>" style="width: 50%; text-align: right; font-weight: 700">Giỏ hàng của bạn</a>
                </div>
            </div>
        </div>
        <form id="myForm" class="checkout" action="<?php echo e(route('cart.order')); ?>" method="POST">
            <div class="container mx-auto px-3">
                <div class="grid grid-cols-12 gap-5 body-checkout" style="display: flex; width: 100%">
                    <div class="col-span-12 lg:col-span-7" style="width: 50%; margin-right:10px">
                        <div style="padding: 0 25px;  color: #111;" class="bg-Pimary_color">
                            <h3 class="text-lg font-semibold mb-2 text-white" style="text-transform: uppercase; font-size: 15px;padding-top: 20px;">Thông
                                tin khách hàng</h3>
                            <div class="grid grid-cols-2 gap-x-5">
                                <?php if($errors->any()): ?>
                                    <div
                                        class="col-span-2 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-2 print-error-msg">
                                ...
                                <?php if(isset($arrStock)): ?>
                                    <div
                                        class="col-span-2 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-2 ">
                                        <strong class="font-bold">ERROR!</strong>
                                ...
                                <div class="col-span-2">
                                    <div>
                                        <?php echo Form::text('fullname', $fullname, ['class' => 'border border-solid border-gray-300 w-full py-1 px-2 mb-5 placeholder-current text-dark h-12 focus:outline-none text-base ip-text', 'autocomplete' => 'off', 'placeholder' => trans('index.Fullname')]); ?>
                                    </div>
                                </div>

                                <div class="col-span-2 lg:col-span-1">
                                    <div>
                                        <?php echo Form::text('email', $email, ['class' => 'border border-solid border-gray-300 w-full py-1 px-2 mb-5 placeholder-current text-dark h-12 focus:outline-none text-base ip-text', 'autocomplete' => 'off', 'placeholder' => 'Email']); ?>
                                    </div>
                                </div>

                                <div class="col-span-2 lg:col-span-1">
                                    <div>
                                        <?php echo Form::text('phone', $phone, ['class' => 'border border-solid border-gray-300 w-full py-1 px-2 mb-5 placeholder-current text-dark h-12 focus:outline-none text-base ip-text', 'autocomplete' => 'off', 'placeholder' => trans('index.Phone')]); ?>
                                    </div>
                                </div>


                                <div class="col-span-2">
                                    <h5 class="text-base font-bold mb-3 text-white">Vui lòng điền đủ thông tin để biết thời gian giao
                                        hàng và phí vận chuyển nếu có!</h5>
                                </div>
                                <div class="col-span-2 mb-5 grid grid-cols-2 md:gap-4">

                                    <div style="margin-right: 10px">
                                        <?php
                                        echo Form::select('city_id', $listCity, $city_id, ['class' => 'bg-transparent border border-solid border-gray-300 w-full py-1 px-2 mb-5 placeholder-current text-dark h-12 focus:outline-none text-base ip-text cl-address', 'id' => 'city']);
                                        ?>
                                    </div>

                                    <div>
                                        <?php
                                        echo Form::select('district_id', $listDistrict, $district_id, ['class' => 'bg-transparent border border-solid border-gray-300 w-full py-1 px-2 mb-5 placeholder-current text-dark h-12 focus:outline-none text-base ip-text cl-address', 'id' => 'district', 'placeholder' => trans('index.District')]);
                                        ?>
                                    </div>

                                    <div style="margin-right: 10px">
                                        <?php
                                        echo Form::select('ward_id', $listWard, $ward_id, ['class' => 'bg-transparent border border-solid border-gray-300 w-full py-1 px-2 mb-5 placeholder-current text-dark h-12 focus:outline-none text-base ip-text cl-address', 'id' => 'ward', 'placeholder' => trans('index.Ward')]);
                                        ?>
                                    </div>

                                    <div>
                                        <?php
                                        echo Form::text('address', $address, ['class' => 'border border-solid border-gray-300 w-full py-1 px-2 placeholder-current text-dark h-12 focus:outline-none text-base ip-text', 'autocomplete' => 'off', 'placeholder' => 'Số nhà , tên đường...']);
                                        ?>
                                    </div>
                                </div>
                    ...
                    <div class="col-span-12 lg:col-span-5 mt-4 mt-lg-0"
                        ...
                        <div>
                                ...
                                <div>
                                    <div class="bg-slate-100 p-2 md:p-10">
                                        <div class="your-order-product-info">
                                            ...
                                            <ul class="flex flex-wrap items-center justify-between border-b  py-5 my-5">
                                                <li class="text-base font-semibold"><?php echo e(trans('index.Provisional')); ?> <span  style="font-style: italic; color: orange;">(<?php echo $cart['quantity'] ?> sản phẩm)</span></li>
                            ...
                            <div class="mt-6 mb-3" style="width: 100%; height: 40px; position: relative">
                                <button type="submit" class="js_btn_submit flex justify-center items-center w-full text-center leading-none uppercase bg-Pimary_color text-white text-sm bg-dark transition-all hover:bg-orange font-semibold" style="width: 50%; height: 100%; position: absolute; margin-left: 24%; border-radius: 30px"><?php echo e(trans('index.Order')); ?></button>
                            </div>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/cart/checkout.blade.php ENDPATH**/ ?>