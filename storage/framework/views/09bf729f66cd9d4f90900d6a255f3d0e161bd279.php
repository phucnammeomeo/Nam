                ...
                <div class="w-4/5 px-[5px]">
                    <div class="flex flex-wrap justify-between mx-[-5px]">
                        <div class="w-1/4 px-[5px]">
                            <div class="main-logo">
                                <a href="https://agri-raw.com/clear-cache"><img src="<?php echo e(asset($fcSystem['homepage_logo'])); ?>"
                                        alt="Logo" /></a>
                            </div>
                        </div>
                        <div class="w-2/4 px-[5px]" style="margin: auto">
                            ...
                            <div class="cart-header flex flex-wrap justify-end items-center h-full">
                                ...
                                <?php endif; ?>
                                    ...
                                    <a href="<?php echo e(route('cart.index')); ?>"
                                        ...
                                        style="background: #008000;height: 100%">
...
<?php /**PATH /home/khangdien2/domains/agri-raw.com/public_html/resources/views/homepage/common/header.blade.php ENDPATH**/ ?>