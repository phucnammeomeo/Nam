                ...
                <div class="blog-standard content-post">
                    ...
                    <article class="post-item post-standard post-195 post type-post status-publish format-standard has-post-thumbnail hentry category-light category-table category-life-style tag-light tag-life-style">
                        <div class="post-thumb">
                            <a href="<?php echo e(route('routerURL',['slug' => $item->slug])); ?>"><img src="<?php echo e(asset($item->image)); ?>" class="img-responsive attachment-1170x768 size-1170x768" alt="<?php echo e($item->title); ?>" width="1170" height="768" style="width: 100%;"></a>
                        </div>
                        <div class="post-info">
                            <h2 class="post-title"><a href="<?php echo e(route('routerURL',['slug' => $item->slug])); ?>"><?php echo e($item->title); ?></a></h2>
                            <div class="post-meta">
                                <div class="date">
                                    <a href="javascript:void(0)"><?php echo e(\Carbon\Carbon::parse($item['created_at'])->format('M')); ?> <?php echo e(\Carbon\Carbon::parse($item['created_at'])->format('d')); ?>, <?php echo e(\Carbon\Carbon::parse($item['created_at'])->format('Y')); ?> </a>
                                </div>
                                <?php if(!empty($item->name)): ?>
                                <div class="post-author">
                                    By:<a href="javascript:void(0)"> <?php echo e($item->name); ?> </a>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <a href="<?php echo e(route('routerURL',['slug' => $item->slug])); ?>" class="readmore">Xem chi tiết</a>
                    </article>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/article/frontend/category/index.blade.php ENDPATH**/ ?>