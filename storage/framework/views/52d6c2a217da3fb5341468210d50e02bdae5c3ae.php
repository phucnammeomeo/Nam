            ...
            <tr class="odd " id="post-<?php echo $v->id; ?>">
                ...
                <td class="">
                    <?php if ($getPrice['price_old']) { ?>
                        <ol style="text-decoration: line-through;"><?php echo $getPrice['price_old'] ?><br></ol>
                    <?php } ?>
...
<!-- END: Pagination -->
<?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/product/backend/product/index/data.blade.php ENDPATH**/ ?>