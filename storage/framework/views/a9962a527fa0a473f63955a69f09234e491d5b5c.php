        ...
        <div class="grid grid-cols-12 -mx-4">
            <div class="col-span-12 lg:col-span-3 px-4 order-last mt-8 lg:mt-0">
                <div class="mt-4 lg:mt-0">
                    ...
                    <!-- END: mã giảm giá -->
                    <div class="mt-3">
                        <a href="<?php echo e(route('cart.checkout')); ?>" class="bg-ColorPrimary w-full text-center inline-block bg-dark leading-none py-4 px-5 md:px-8 text-sm text-white transition-all hover:bg-orange uppercase font-semibold hover:text-white"><?php echo e(trans('index.Pay')); ?></a>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/cart/index.blade.php ENDPATH**/ ?>