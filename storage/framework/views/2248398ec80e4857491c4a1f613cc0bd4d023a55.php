            ...
            <div class="w-[580px] max-w-full bg-[#f4f6f8] p-6 rounded-xl " style="border: solid 1px orange">
                ...
                <form action="<?php echo e(route('customer.login-store')); ?>" method="POST" id="form-auth">
                    ...
                    <div class="mt-5 flex justify-center ">
                        <button type="submit" class=" bg-Pimary_color btn-submit-contact py-4 px-1 md:px-8 rounded-lg block bg-[#3bb77e]  text-white transition-all leading-none text-f15 font-bold" style="width: 50%"> <?php echo e(trans('index.Login')); ?></button>
                    </div>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/customer/frontend/auth/login.blade.php ENDPATH**/ ?>