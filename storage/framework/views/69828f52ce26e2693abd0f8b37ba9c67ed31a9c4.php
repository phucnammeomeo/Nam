                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="<?php echo e($v->name); ?>" class=" rounded-full" src="<?php echo File::exists(base_path($v->image)) ? asset($v->image) : 'https://ui-avatars.com/api/?name=' . $detail->name ?>">
                            </div>
                        </td>
                        <td>
                            <?php echo e($v->name); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/user/backend/user/index.blade.php ENDPATH**/ ?>