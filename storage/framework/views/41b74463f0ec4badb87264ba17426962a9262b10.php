                                ...
                                <ul class="admin-date flex flex-wrap text-gray-500 my-[10px]">
                                    <?php if(!empty($item->name)): ?>
                                        <li class="mr-[10px]"><span class="mr-[5px]"><i
                                                        class="fa-solid fa-user"></i></span><?php echo e($item->name); ?></li>
                                    <?php endif; ?>
                                    <li><span class="mr-[5px]"><i
                                                    class="fa-solid fa-calendar-days"></i></span><?php echo e(\Carbon\Carbon::parse($item['created_at'])->format('M')); ?> <?php echo e(\Carbon\Carbon::parse($item['created_at'])->format('d')); ?>

                                        , <?php echo e(\Carbon\Carbon::parse($item['created_at'])->format('Y')); ?></li>
                                </ul>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/article/frontend/category/index.blade.php ENDPATH**/ ?>