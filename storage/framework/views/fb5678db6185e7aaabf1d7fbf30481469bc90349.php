...
<div class="grid grid-cols-12 border-t py-5">
    ...
    <div class="col-span-12 md:col-span-8 mt-5 md:mt-0 ml-5">
        ...
        <div class="flex flex-wrap ">
            <?php $__currentLoopData = $listImageCmt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="review-comment__image mb-2 mr-2 border border-slate-50" style="background-image: url(<?php echo e($image); ?>);">
                <a href="<?php echo $image ?>" data-fancybox="images" rel="group1<?php echo e($key); ?>">
...
</div><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/product/frontend/product/comment/data.blade.php ENDPATH**/ ?>