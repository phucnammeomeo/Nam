            ...
            <div class="flex flex-wrap justify-between mx-[-5px]">
                <div class="w-1/5 px-[5px]">
                    <div class="main-logo" style="height: 126px">
                        <a href="<?php echo e(url('/')); ?>">
                            <img src="<?php echo e(asset($fcSystem['homepage_logo'])); ?>" alt="<?php echo e($fcSystem['homepage_company']); ?>" style="height: 100% ; margin:auto"/>
                        </a>
                    </div>
                </div>
                            ...
                            <div class="main-search relative">
                                <form action="<?php echo route('homepage.search') ?>">
                                    ...
                                    <div class="relative inline-block w-full mt-[4px] click-search cursor-pointer">
                                        <input type="text" name="keyword" value="<?php echo e(request()->keyword); ?>" placeholder="<?php echo e($fcSystem['title_1']); ?>" style="height: 40px" class="search-keyword text-f13 border border-gray-100 rounded-[20px] w-full pl-[35px] cursor-pointer"/>
                                        <button type="submit" class="absolute top-[10px] left-[13px]">
                                            <i class="fa-solid fa-magnifying-glass text-f13 text-gray-400"></i>
                                        </button>
                                    </div>
                                    <?php echo $__env->make('homepage.common.advanceSearch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </form>
                            </div>
                        </div>
                ...
                <div class="w-1/5 px-[5px]">
                    <div class="cart-header flex flex-wrap justify-end items-center h-full">
                        <?php echo $__env->make('homepage.common.headerCart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <a href="<?php echo e((!empty(Auth::guard('customer')->user()->id)) ? route('customer.dashboard') : route('customer.login')); ?>" class="text-f14 text-white flex items-center">
    ...
    <div class="relative flex justify-center px-2 py-[10px] header-22">
        ...
        <div class="w-full text-center">
            ...
            <a href="<?php echo e(url('/')); ?>" class="logo">
                <img src="<?php echo e($fcSystem['homepage_logo']); ?>" alt="<?php echo e($fcSystem['homepage_company']); ?>" class="inline-block"/>
            </a>
        </div>
        <nav id="primary-nav" class="dropdown cf mobile" style="display: none">
            <?php if( $menu_header ): ?>
                <ul class="dropdown menu">
                    <?php $__currentLoopData = $menu_header->menu_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            ...
                            <?php if( !$val->children->isEmpty() ): ?>
                                <ul class="sub-menu">
                                    <?php $__currentLoopData = $val->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyC => $valC): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e(url($valC->slug)); ?>"><?php echo e($valC->title); ?></a></li>
    ...
    <div class="pb-[10px]">
        <div class="main-search relative px-[10px]">
            <form action="<?php echo route('homepage.search') ?>">
                <div class="relative inline-block w-full mt-[4px] click-search cursor-pointer">
                    <?php echo csrf_field(); ?>
                    <input type="text" placeholder="<?php echo e($fcSystem['title_1']); ?>" style="height: 40px" class="search-keyword text-f13 border border-gray-100 rounded-[20px] w-full pl-[35px] cursor-pointer"/>
                    <button class="absolute top-[10px] left-[13px]">
                        <i class="fa-solid fa-magnifying-glass text-f13 text-gray-400"></i>
                    </button>
                </div>
...
<?php /**PATH /home/vuong/domains/vuong.tamphat.edu.vn/public_html/resources/views/homepage/common/header.blade.php ENDPATH**/ ?>