<?php /*<div class="offcanvas-overlay fixed inset-0 bg-black opacity-50 z-50 hidden"></div>
<div id="offcanvas-cart" style="z-index: 99999;" class="offcanvas left-auto right-0 transform fixed font-normal text-sm top-0 z-50 h-screen w-80 lg:w-96 transition-all ease-in-out duration-300 bg-white overflow-y-auto hidden animated fadeInRight">
    <div class="p-8">
        <div class="flex flex-wrap justify-between items-center pb-6 mb-6 border-b border-solid border-gray-600">
            <h4 class="font-normal text-xl">{{trans('index.Cart')}}</h4>
        ...
        <div id="cart-show-header" <?php if (empty($cart['cart'])) { ?> style="display: none" <?php } ?>>
            ...
            <div>
                ...
                <div class="text-center">
                    <a class="py-5 px-10 block bg-white border border-solid border-gray-600 uppercase font-semibold text-base hover:bg-red-600 hover:border-red-600 hover:text-white transition-all leading-none" href="{{route('cart.index')}}">{{trans('index.Cart')}}</a>

                    <a class="py-5 px-10 block bg-white border border-solid border-gray-600 uppercase font-semibold text-base hover:bg-red-600 hover:border-red-600  hover:text-white transition-all leading-none  mt-3" href="{{route('cart.checkout')}}">{{trans('index.Pay')}}</a>
                </div>
            </div>
        </div>
...
<!-- end --><?php /**PATH /home/globalmat/domains/globalmat.vn/public_html/resources/views/homepage/common/cart.blade.php ENDPATH**/ ?>