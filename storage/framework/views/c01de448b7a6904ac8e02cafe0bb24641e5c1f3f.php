    ...
    <div class="section-001 section-009" id="widget-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 widget">
                    <h2 class="widgettitle">Facebook<span class="arrow"></span>
                    </h2>
                    <div class=" ">
                        <div class="fb-page" data-href="<?php echo e($fcSystem['social_facebook']); ?>" data-tabs="timeline" data-width="" data-height="230" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="<?php echo e($fcSystem['social_facebook']); ?>" class="fb-xfbml-parse-ignore"><a href="<?php echo e($fcSystem['social_facebook']); ?>">Trái Cây Nhập Khẩu Hà Nội</a></blockquote>
                        </div>
                    </div>
                </div>
            </div>
...
</div>*/ ?><?php /**PATH D:\xampp\htdocs\food.local\resources\views/homepage/common/footer.blade.php ENDPATH**/ ?>