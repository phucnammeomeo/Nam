<div class="top-bar">
    ...
    <div class=" mr-auto sm:mr-6">
        <div class="notification cursor-pointer">
            ...
            <div class="dropdown"> <button class="dropdown-toggle btn btn-primary" aria-expanded="false" data-tw-toggle="dropdown">
                    <?php echo config('language')[config('app.locale')]['title'] ?>
                </button>
    ...
    <div class=" dropdown text-slate-200 h-10">
        <div class="h-full dropdown-toggle flex items-center" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            <div class="w-10 h-10 image-fit">
                <img alt="<?php echo e(!empty(Auth::user())?Auth::user()->name:''); ?>" class="rounded-full border-2 border-white border-opacity-10 shadow-lg" src="<?php echo e(!empty(Auth::user()->image)?url(Auth::user()->image):asset('images/404.png')); ?>">
            </div>
...
<?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/dashboard/common/header.blade.php ENDPATH**/ ?>