            ...
            <?php /* <div class="box p-5 pt-3 hidden">
                ...
                <div>
                    ...
                    <div class="flex items-center mt-2">
                        <img src="{{asset(config('language')[$detail->alanguage]['image'])}}" alt="language icon">
                ...
                <div class="mt-3">
                    ...
                    <div class="flex items-center mt-2">
                        ...
                        <div class="flex-1 ml-2 flex items-center">
                            ...
                            <input class="form-control w-full title" name="title" type="text" value="">
                        </div>
                    </div>
                    @endif
                    @endforeach
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khangdien2/domains/khangdien.tamphat.edu.vn/public_html/resources/views/product/backend/product/edit.blade.php ENDPATH**/ ?>