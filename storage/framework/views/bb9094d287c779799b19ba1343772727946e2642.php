                    ...
                    <?php foreach ($image_json as $key => $item) {
                        if (!empty($item != 'undefined')) {
                            if (File::exists(base_path($item))) { ?>
                                var mockFile = {
                                    name: '<?php echo $item ?>',
                                    size: <?php echo filesize(base_path($item)); ?>
                                };
...
<!-- end: dropzone upload image --><?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/components/dropzone.blade.php ENDPATH**/ ?>