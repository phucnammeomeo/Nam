...
<div id="menu-items">
    <div id="faq-accordion-2" class="accordion accordion-boxed">
        ...
        if($detail->slug == 'menu-danh-muc-san-pham')
            $array = [            
                ...
                <div class="accordion-item bg-white" style="padding: 10px 10px 11px 14px;">
                    <div id="faq-accordion-content-<?php echo $i; ?>" class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-tw-toggle="collapse"
                            data-tw-target="#faq-accordion-collapse-<?php echo $i; ?>" aria-expanded="false"
                            aria-controls="faq-accordion-collapse-<?php echo $i; ?>"><?php echo e($value); ?></button>
                    </div>
                    <div id="faq-accordion-collapse-<?php echo $i; ?>" class="accordion-collapse collapse"
                        aria-labelledby="faq-accordion-content-<?php echo $i; ?>" data-tw-parent="#faq-accordion-2">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('menus_create')): ?>
                            <div class="flex mt-3">
                                <label class="btn btn-sm btn-default mr-2">
                                    <input type="checkbox" name="clickAllMenu" class="hidden">&nbsp;<span>Chọn toàn
                                        bộ</span>
                                </label>
                                <button type="button" class="btn btn-sm btn-primary add-menu-item"
                                    data-module="<?php echo $key; ?>">Thêm vào menu</button>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <?php if($detail->slug == 'menu-danh-muc-san-pham'): ?>
            <div class="accordion-item bg-white" style="padding: 10px 10px 11px 14px; display: none;">
                <div id="faq-accordion-content-5" class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-tw-toggle="collapse"
                        data-tw-target="#faq-accordion-collapse-5" aria-expanded="false"
                        aria-controls="faq-accordion-collapse-5">Liên kết tự tạo
                    </button>
                </div>
...
<?php /**PATH /home/khangdien3/domains/khangdien.tamphat.edu.vn/public_html/resources/views/menu/backend/module.blade.php ENDPATH**/ ?>