<?php $__env->startSection('content'); ?>
    ...
    ?>
    <div class="py-9 bg-white px-4 main-checkout" style="margin-top: 10px">
        <div style="display: flex; width:100%" class="title-checkout">
            <div style="width: 50%; margin-top: 10px" class="title-checkout">
            ...
            <div style="width: 50%; margin-top: 10px; display: flex; " class="group-btn">
                ...
                <div class="grid grid-cols-12 gap-5 body-checkout" style="display: flex; width: 100%">
                    <div class="col-span-12 lg:col-span-7" style="width: 50%; margin-right:10px">
                        <div style="padding: 0 25px;  color: #111;" class="bg-Pimary_color">
                            <h3 class="text-lg font-semibold mb-2" style="text-transform: uppercase; font-size: 15px">Thông
                                tin khách hàng</h3>
                            <div class="grid grid-cols-2 gap-x-5">
                                ...
                                <div class="col-span-2">
                                    <h5 class="text-base font-bold mb-3">Vui lòng điền đủ thông tin để biết thời gian giao
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vuong/domains/vuong.tamphat.edu.vn/public_html/resources/views/cart/checkout.blade.php ENDPATH**/ ?>