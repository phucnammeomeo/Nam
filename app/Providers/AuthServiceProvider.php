...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function gateKeyWord()
    {
        Gate::define('keywords_index', [KeyWordPolicy::class, 'index']);
        Gate::define('keywords_create', [KeyWordPolicy::class, 'create']);
        Gate::define('keywords_edit', [KeyWordPolicy::class, 'edit']);
        Gate::define('keywords_destroy', [KeyWordPolicy::class, 'destroy']);
    }
