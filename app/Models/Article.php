...
class Article extends Model
{
    ...
    {
        return $this->hasMany(Catalogues_relationships::class, 'moduleid')->where('module', 'articles');
    }
    ...
    {
        return $this->hasMany(Tags_relationship::class, 'module_id', 'id')->where('tags_relationships.module', '=', 'articles');
    }
