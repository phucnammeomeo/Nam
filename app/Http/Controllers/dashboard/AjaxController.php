...
class AjaxController extends Controller
{
    ...
    public function delete_function($id = 0, $module = '', $child = 0)
    {
        ...
        if ($module == 'category_articles' || $module == 'category_products' || $module == 'category_media' || $module == 'tour_categories' || $module == 'brands') {
