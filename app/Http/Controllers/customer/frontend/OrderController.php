...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('customer/frontend/order/index', compact('fcSystem', 'seo', 'data','slideHome','OurFeatures','partners'));
    }
    /*Chi tiết đơn hàng */
    public function detail($id)
    {
        ...
        return view('customer/frontend/order/detail', compact('seo', 'detail', 'fcSystem','slideHome','OurFeatures','partners'));
    }
    /*Chỉnh sửa đơn hàng */
