...
class CustomerController extends Controller
{
    ...
    public function login()
    {
        ...
        return view('customer/frontend/auth/login', compact('fcSystem', 'seo', 'page', 'slideHome','partners','OurFeatures'));
    }
    ...
    public function register()
    {
        ...
        $fcSystem = $this->system->fcSystem();
        $fcSystem = $this->system->fcSystem();
        return view('customer/frontend/auth/register', compact('fcSystem', 'seo', 'slideHome','partners','OurFeatures'));
    }
    ...
    public function reset_password()
    {
        ...
        $fcSystem = $this->system->fcSystem();
        return view('customer.frontend.auth.reset-password', compact('fcSystem', 'slideHome','partners','OurFeatures'));
    }
